...
public class BookController {
    ...
    @GetMapping("/borrowed")
    public ResponseEntity<PageResponse<BorrowedBookRepsonse>> findAllBorrowedBooks(
            @RequestParam(name ="page", defaultValue = "0", required = false) int page,
            @RequestParam(name ="size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
    ...
    @GetMapping("/returned")
    public ResponseEntity<PageResponse<BorrowedBookRepsonse>> findAllReturnedBooks(
            @RequestParam(name ="page", defaultValue = "0", required = false) int page,
            @RequestParam(name ="size", defaultValue = "10", required = false) int size,
            Authentication connectedUser
    ){
    ...
    public ResponseEntity<Integer> approveReturnedBorrowBook(
        ...
        return ResponseEntity.ok(service.approveReturnedBorrowBook(bookId, connectedUser));
    }
